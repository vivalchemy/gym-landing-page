...
<div class="grid grid-cols-1 md:grid-cols-2 gap-14 lg:gap-20 relative text-base">
	...
	>
		<div class="rounded-t-xl h-8 sm:h-10 bg-white opacity-60 px-3 flex items-center gap-2">
			{#each [1, 2, 3] as i}
				<div class="aspect-square rounded-full w-2.5 sm:w-3 bg-indigo-300"></div>
			{/each}
		</div>
		<div class="flex flex-col be-white gap-4 flex-1">
