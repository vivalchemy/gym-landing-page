...
<footer class="py-16 sm:py-20 md:py-24 px-4 md:px8">
	<div
	...
	>
		<div class="flex flex-col gap-4 md:col-span-2">
			...
			<p>&#169;2023 SWOLEY MOLEY LTD. All right reserved.</p>
		</div>
		...
		<div class="flex flex-col gap-4">
			...
			<a href="" target="_blank" class="cursor-pointer hover:text-indigo-400 duration-200"
				><i class="fa-brands fa-instagram pr-2"></i>Instagram</a
			>
			<a href="" target="_blank" class="cursor-pointer hover:text-indigo-400 duration-200"
				><i class="fa-brands fa-youtube pr-2"></i>Youtube</a
			>
			<a href="" target="_blank" class="cursor-pointer hover:text-indigo-400 duration-200"
				><i class="fa-brands fa-facebook pr-2"></i>Facebook</a
			>
			<a href="" target="_blank" class="cursor-pointer hover:text-indigo-400 duration-200"
				><i class="fa-brands fa-twitter pr-2"></i>Twitter</a
			>
		</div>
	</div>
</footer>
